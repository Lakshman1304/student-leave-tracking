<?php
    ...
    $sql="update tblstudents set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where EmailId=:eid";
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="leave.php"><img src="../assets/images/icon/iselogo.jpg" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
