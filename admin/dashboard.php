    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="dashboard.php"><img src="../assets/images/icon/iselogo.jpg" alt="logo" style="border-radius: 50%;"></a>
                </div>
            </div>
            <div class="main-menu">
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="d-flex justify-content-between pb-2">
                                        <h1><?php include 'counters/admin-counter.php'?></h1>
                                        ...
                                        <div class="single-table">
                                            <div class="table-responsive">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT tblleaves.id as lid,tblstudents.FirstName,tblstudents.LastName,tblstudents.EmpId,tblstudents.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status from tblleaves join tblstudents on tblleaves.empid=tblstudents.id order by lid desc limit 7";
