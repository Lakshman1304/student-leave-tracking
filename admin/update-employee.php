<?php
    ...
    $sql="UPDATE tblstudents set FirstName=:fname,LastName=:lname,Gender=:gender,Dob=:dob,Address=:address,City=:city,Country=:country,Phonenumber=:mobileno where id=:eid";
