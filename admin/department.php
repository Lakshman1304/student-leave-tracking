                    ...
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            ...
                            <ul class="breadcrumbs pull-left">
                                ...
                                <li><span>Mentor Management</span></li>
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-department.php" class="btn btn-sm btn-info">Add New Mentor</a></center>
                                    <table id="dataTable3" class="table table-hover table-striped text-center">
                                        ...
                                        <tbody>
                                    <?php $sql = "SELECT * from tblmentors";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    ...
                                    {               ?>  
                                        <tr>
                                            ...
                                            <td><?php echo htmlentities($result->MentorName);?></td>
                                            <td><?php echo htmlentities($result->MentorID);?></td>
