<?php
    ...
    $sql="INSERT INTO tblstudents(EmpId,FirstName,LastName,EmailId,Password,Gender,Dob,Address,City,Country,Phonenumber,Status) VALUES(:empid,:fname,:lname,:email,:password,:gender,:dob,:address,:city,:country,:mobileno,:status)";
